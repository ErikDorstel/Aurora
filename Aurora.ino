...
const char* password="";
String header; boolean debug=false;
...
void setup() {
  ...
  if (debug) { Serial.print("AP IP address: "); Serial.println(IP); }
  server.begin(); }

void loop() {
  WiFiClient client=server.available();
  if (client) { String currentLine=""; if (debug) { Serial.println("New Client."); }
    ...
    header = ""; client.stop(); if (debug) { Serial.println("Client disconnected."); Serial.println(""); } } }
